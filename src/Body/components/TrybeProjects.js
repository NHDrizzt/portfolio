...
import trybeLogoLarge from "../../assets/images/trybeLogo-large.png";
import trybeLogoSmall from "../../assets/images/trybeLogo-small.png";
        ...
        <>
            <div ref={trybeProjectsFrontEnd} className={`${"project"} ${"trybe-projects-frontend"} ${trybeProjectsFrontEndIsVisible ? 'trybe-projects-frontend-effect' : ''}`}>
                <div className="proj-hover">
                    ...
                    <div className="project-view-code-hover middle-hover">
                        <a href="https://github.com/NHDrizzt/trybe-projects" target="_blank">
                            <h3>View code</h3>
                        </a>
                    </div>
                </div>
        
                <h2>Trybe Frontend projects</h2>
            ...
            <div ref={chosenTrybeProjectFrontend} className={`${"project"} ${"trybe-projects-frontend"} ${chosenTrybeProjectFrontendIsVisible ? 'trybe-projects-frontend-effect' : ''}`}>
                <div className="proj-hover">
                    ...
                    <div className="project-view-code-hover middle-hover">
                        <a href="https://voracious-show.surge.sh/" target="_blank">
                            <h3>View project</h3>
                        </a>
                        <a href="https://github.com/NHDrizzt/portfolio" target="_blank">
                            <h3>View code</h3>
                ...
                <div className="project-view-code">
                    ...
                    <a href="https://github.com/NHDrizzt/trybe-projects/tree/main/sd-030-a-project-recipes-app" target="_blank">
                        <h3>View code</h3>
                    </a>
                </div>
            </div>
